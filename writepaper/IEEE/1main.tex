...
\end{figure*}
#这个不知道要不要引用
Utilizing electromagnetic wave reflections arising from dielectric permittivity contrasts at material interfaces, Ground Penetrating Radar (GPR) has become a widely deployed non-destructive technique for mapping geological structures and identifying buried objects.
