...
\begin{figure}[]
    \centering
  \subfloat[\footnotesize Raw image.]{\includegraphics[width=0.31\linewidth]{example-yuantu.png}}
  \hfill
  \subfloat[\footnotesize Annotated hyperbola band.]{\includegraphics[width=0.31\linewidth]{example-shuangquxian.png}}
  \hfill
  \subfloat[\footnotesize Derived bounding box.]{\includegraphics[width=0.31\linewidth]{example-bbox.png}}
...
\subsection{Generalization to an Additional Dataset}
