...
def mirrored_output_path(sgy_path: Path, input_root: Path, output_root: Path) -> Path:
    """Mirror sgy_path's location relative to input_root under output_root, as .png."""
    return output_root / sgy_path.relative_to(input_root).with_suffix(".png")
...
def main() -> None:
    ...
    for sgy_path in sgy_files:
        ...
        output_path = mirrored_output_path(sgy_path, input_root, output_dir)
